...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/subsxript.js":[function(require,module,exports) {
// ------------------------------------Mobile headermenu 
...
var baenertap = document.querySelectorAll(".baenerText_title ul li a");
var baenerCont = document.querySelectorAll(".baenerText_cont");
baenertap.forEach(function (tab) {
  tab.addEventListener('click', function (event) {
    event.preventDefault();
    var contentId = tab.getAttribute('data-content');
    baenerCont.forEach(function (item) {
      item.style.display = 'none';
    });
    document.getElementById(contentId).style.display = 'block';
    baenertap.forEach(function (t) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/subsxript.js"], null)
//# sourceMappingURL=/subsxript.21e4a350.js.map